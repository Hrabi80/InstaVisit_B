 ...
 */
final class Version20200215203812 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE map ADD housenm_id INT DEFAULT NULL, CHANGE house_id_id house_id_id INT DEFAULT NULL, CHANGE house_lm_id_id house_lm_id_id INT DEFAULT NULL, CHANGE map map VARCHAR(800) DEFAULT NULL, CHANGE virtual_tour virtual_tour VARCHAR(800) DEFAULT NULL');
        $this->addSql('ALTER TABLE map ADD CONSTRAINT FK_93ADAABBB52753FC FOREIGN KEY (housenm_id) REFERENCES for_rent (id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_93ADAABBB52753FC ON map (housenm_id)');
        ...
        $this->addSql('ALTER TABLE for_rent CHANGE transport_id transport_id INT DEFAULT NULL, CHANGE vcar_id vcar_id INT DEFAULT NULL, CHANGE map_id map_id INT DEFAULT NULL, CHANGE city city VARCHAR(255) DEFAULT NULL, CHANGE main_img main_img VARCHAR(255) DEFAULT NULL, CHANGE cover cover VARCHAR(255) DEFAULT NULL, CHANGE piece piece INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE vcar ADD housenm_id INT DEFAULT NULL, CHANGE id_house_id id_house_id INT DEFAULT NULL, CHANGE house_lm_id_id house_lm_id_id INT DEFAULT NULL, CHANGE cave cave TINYINT(1) DEFAULT NULL, CHANGE ascenceur ascenceur TINYINT(1) DEFAULT NULL, CHANGE gardienne gardienne TINYINT(1) DEFAULT NULL');
        $this->addSql('ALTER TABLE vcar ADD CONSTRAINT FK_E76C1FD3B52753FC FOREIGN KEY (housenm_id) REFERENCES for_rent (id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_E76C1FD3B52753FC ON vcar (housenm_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE cuisine CHANGE house_id_id house_id_id INT DEFAULT NULL, CHANGE refri refri TINYINT(1) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE equipement CHANGE house_id_id house_id_id INT DEFAULT NULL, CHANGE boite boite TINYINT(1) DEFAULT \'NULL\', CHANGE interphone interphone TINYINT(1) DEFAULT \'NULL\', CHANGE lavelange lavelange TINYINT(1) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE for_rent CHANGE transport_id transport_id INT DEFAULT NULL, CHANGE vcar_id vcar_id INT DEFAULT NULL, CHANGE map_id map_id INT DEFAULT NULL, CHANGE city city VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE main_img main_img VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE cover cover VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE piece piece INT DEFAULT NULL');
        ...
        $this->addSql('DROP INDEX UNIQ_93ADAABBB52753FC ON map');
        $this->addSql('ALTER TABLE map DROP housenm_id, CHANGE house_id_id house_id_id INT DEFAULT NULL, CHANGE house_lm_id_id house_lm_id_id INT DEFAULT NULL, CHANGE map map VARCHAR(800) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE virtual_tour virtual_tour VARCHAR(800) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
        ...
        $this->addSql('DROP INDEX UNIQ_E76C1FD3B52753FC ON vcar');
        $this->addSql('ALTER TABLE vcar DROP housenm_id, CHANGE id_house_id id_house_id INT DEFAULT NULL, CHANGE house_lm_id_id house_lm_id_id INT DEFAULT NULL, CHANGE cave cave TINYINT(1) DEFAULT \'NULL\', CHANGE ascenceur ascenceur TINYINT(1) DEFAULT \'NULL\', CHANGE gardienne gardienne TINYINT(1) DEFAULT \'NULL\'');
    }
}
