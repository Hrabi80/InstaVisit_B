 ...
 */
final class Version20200215195007 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE for_rent ADD transport_id INT DEFAULT NULL, ADD vcar_id INT DEFAULT NULL, ADD map_id INT DEFAULT NULL, CHANGE city city VARCHAR(255) DEFAULT NULL, CHANGE main_img main_img VARCHAR(255) DEFAULT NULL, CHANGE cover cover VARCHAR(255) DEFAULT NULL, CHANGE piece piece INT DEFAULT NULL');
        $this->addSql('ALTER TABLE for_rent ADD CONSTRAINT FK_D1CD2C599909C13F FOREIGN KEY (transport_id) REFERENCES transport (id)');
        $this->addSql('ALTER TABLE for_rent ADD CONSTRAINT FK_D1CD2C5960D06D53 FOREIGN KEY (vcar_id) REFERENCES vcar (id)');
        $this->addSql('ALTER TABLE for_rent ADD CONSTRAINT FK_D1CD2C5953C55F64 FOREIGN KEY (map_id) REFERENCES map (id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_D1CD2C599909C13F ON for_rent (transport_id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_D1CD2C5960D06D53 ON for_rent (vcar_id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_D1CD2C5953C55F64 ON for_rent (map_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE cuisine CHANGE house_id_id house_id_id INT DEFAULT NULL, CHANGE refri refri TINYINT(1) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE equipement CHANGE house_id_id house_id_id INT DEFAULT NULL, CHANGE boite boite TINYINT(1) DEFAULT \'NULL\', CHANGE interphone interphone TINYINT(1) DEFAULT \'NULL\', CHANGE lavelange lavelange TINYINT(1) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE for_rent DROP FOREIGN KEY FK_D1CD2C599909C13F');
        $this->addSql('ALTER TABLE for_rent DROP FOREIGN KEY FK_D1CD2C5960D06D53');
        $this->addSql('ALTER TABLE for_rent DROP FOREIGN KEY FK_D1CD2C5953C55F64');
        $this->addSql('DROP INDEX UNIQ_D1CD2C599909C13F ON for_rent');
        $this->addSql('DROP INDEX UNIQ_D1CD2C5960D06D53 ON for_rent');
        $this->addSql('DROP INDEX UNIQ_D1CD2C5953C55F64 ON for_rent');
        $this->addSql('ALTER TABLE for_rent DROP transport_id, DROP vcar_id, DROP map_id, CHANGE city city VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE main_img main_img VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE cover cover VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci, CHANGE piece piece INT DEFAULT NULL');
