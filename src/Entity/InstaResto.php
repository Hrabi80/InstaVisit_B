...
class InstaResto implements \JsonSerializable
{
    ...
    /**
     * @ORM\OneToOne(targetEntity="App\Entity\Techn", mappedBy="instaResto", cascade={"persist", "remove"},orphanRemoval=true)
     */
    private $tech;

    /**
     * @ORM\OneToOne(targetEntity="App\Entity\Map", mappedBy="resto_id", cascade={"persist", "remove"},orphanRemoval=true)
     */
    private $map;

    /**
     * @ORM\OneToOne(targetEntity="App\Entity\Transport", mappedBy="instaResto", cascade={"persist", "remove"},orphanRemoval=true)
     */
    private $transport;
